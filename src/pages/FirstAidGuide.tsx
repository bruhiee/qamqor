...
const firstAidGuidesEnglish: FirstAidGuide[] = [
  {
    id: "cpr",
...
const firstAidGuidesRu: FirstAidGuide[] = [
  {
    id: "cpr",
    ...
    severity: "critical",
    overview:
      "СЛР — это техника спасения жизни при остановке сердца и дыхания. Быстрая реакция может удвоить или утроить шансы на выживание.",
    callEmergency: true,
    steps: [
      {
        step: 1,
        title: "Проверьте реакцию",
        description: "Потрясите за плечо и громко спросите «Вы в порядке?» Следите за дыханием и движением грудной клетки.",
      },
      {
        step: 2,
        title: "Позвоните в скорую",
        description: "Наберите 103 (Казахстан) или местный экстренный номер и включите громкую связь.",
        warning: "Не откладывайте — каждая секунда важна!",
      },
      {
        step: 3,
        title: "Подготовьте пострадавшего",
        description: "Положите его на спину на твердую, ровную поверхность.",
      },
      {
        step: 4,
        title: "Начните компрессии",
        description:
          "Положите пятку одной руки в центр груди, вторую руку сверху. Нажимайте глубоко (не менее 5 см) и быстро (100-120 раз в минуту).",
      },
      {
        step: 5,
        title: "Искусственное дыхание (если умеете)",
        description:
          "Запрокиньте голову, приподнимите подбородок, зажмите нос и сделайте два вдоха по ~1 секунде.",
      },
      {
        step: 6,
        title: "Продолжайте СЛР",
        description: "Чередуйте 30 компрессий и 2 вдоха. Не прекращайте до приезда помощи или восстановления дыхания.",
      },
    ],
    doNots: [
      "Не сдавайтесь — продолжайте СЛР до приезда помощи",
      "Не делайте компрессии медленно или неглубоко",
      "Не прерывайте компрессии более чем на 10 секунд",
    ],
    whenToSeekHelp: "Всегда вызывайте скорую, если человек без сознания и не дышит нормально.",
  },
  {
    id: "choking",
    title: "Давка (прием Геймлиха)",
    icon: AlertTriangle,
    color: "#F97316",
    severity: "critical",
    overview:
      "Давка случается, когда инородное тело блокирует дыхание. Прием Геймлиха восстанавливает проходимость при быстром применении.",
    callEmergency: true,
    steps: [
      {
        step: 1,
        title: "Признаки удушья",
        description: "Человек не может говорить, кашлять или дышать. Может хвататься за горло, кожа становится синей.",
      },
      {
        step: 2,
        title: "Спросите разрешение",
        description: "Если человек в сознании, скажите: «Вы задыхаетесь? Могу я помочь?»",
      },
      {
        step: 3,
        title: "Станьте сзади",
        description: "Встаньте позади пострадавшего и поставьте одну ногу между его ног для устойчивости.",
      },
      {
        step: 4,
        title: "Сожмите кулак",
        description: "Сделайте кулак (большой палец внутрь) и разместите чуть выше пупка, под ребрами.",
      },
      {
        step: 5,
        title: "Выполните абдоминальные толчки",
        description:
          "Обхватите кулак другой рукой и резко тяните внутрь и вверх, чтобы вытолкнуть предмет.",
      },
      {
        step: 6,
        title: "Повторяйте до освобождения",
        description: "Продолжайте толчки, пока предмет не выйдет или человек не потеряет сознание.",
      },
    ],
    doNots: [
      "Не применяйте прием на беременных (используйте грудные толчки)",
      "Не бейте по спине стоящему взрослому",
      "Не засовывайте пальцы в рот без видимого предмета",
    ],
    whenToSeekHelp:
      "Если давка не проходит, человек теряет сознание или дыхание не восстанавливается — вызывайте скорую.",
  },
  {
    id: "burns",
    title: "Ожоги и паровые ожоги",
    icon: Flame,
    color: "#DC2626",
    severity: "urgent",
    overview:
      "Охлаждение ожога уменьшает повреждение тканей. Степень поражения определяет, нужна ли медицинская помощь.",
    callEmergency: false,
    steps: [
      {
        step: 1,
        title: "Удалите от источника",
        description:
          "Отведите пострадавшего подальше от огня или горячего предмета. Снимите одежду и украшения, если они не приклеены.",
      },
      {
        step: 2,
        title: "Охладите ожог",
        description: "Ополосните ожог прохладной (не ледяной) проточной водой минимум 20 минут.",
        warning: "Не используйте лед, ледяную воду, крем, масло или пасту.",
      },
      {
        step: 3,
        title: "Оцените степень",
        description:
          "Первая степень: красная, сухая кожа. Вторая: пузыри и влажность. Третья: белая или обугленная кожа, может отсутствовать боль.",
      },
      {
        step: 4,
        title: "Закройте ожог",
        description: "Накройте стерильной марлей или чистой тканью, не затягивая слишком сильно.",
      },
      {
        step: 5,
        title: "Обезболивание",
        description: "Дайте безрецептурное обезболивающее и держите пораженный участок приподнятым.",
      },
      { step: 6, title: "Следите за шоком", description: "Держите человека в тепле и спокойствии, наблюдайте за состоянием." },
    ],
    doNots: [
      "Не прикладывайте лед напрямую к ожогу",
      "Не протыкайте пузыри",
      "Не наносите масло, крем или зубную пасту",
      "Не снимайте одежду, если она прилипла к коже",
    ],
    whenToSeekHelp:
      "Обратитесь за помощью, если ожог больше ладони, на лице, руках, стопах, гениталиях, химический или электрический, или если появились пузыри.",
  },
  {
    id: "bleeding",
    ...
    severity: "critical",
    overview:
      "Закрытие ран и приподнимание помогают контролировать сильное кровотечение. Быстрое давление на рану спасает жизнь.",
    callEmergency: true,
    steps: [
      {
        step: 1,
        title: "Обеспечьте безопасность",
        description: "Наденьте перчатки, если есть. Убедитесь, что место безопасно.",
      },
      { step: 2, title: "Прижмите рану", description: "Наложите чистую ткань и сильно прижмите, не поднимайте повязку." },
      {
        step: 3,
        title: "Поднимите конечность",
        description: "Держите рану выше уровня сердца, если позволяет травма.",
      },
      {
        step: 4,
        title: "Добавьте давление",
        description: "Если ткань промокла, добавьте новый слой, не снимая первую повязку.",
      },
      {
        step: 5,
        title: "Давление на артерию",
        description: "Если кровь не останавливается, прижмите артерию между раной и сердцем.",
      },
      {
        step: 6,
        title: "Зафиксируйте повязку",
        description: "Когда кровотечение замедлится, закрепите повязку, но не пережимайте слишком сильно.",
      },
    ],
    doNots: [
      "Не снимайте первую повязку, если она промокла",
      "Не используйте жгут без подготовки, если кровотечение не угрожает жизни",
      "Не промывайте глубокие раны",
    ],
    whenToSeekHelp:
      "Вызывайте скорую при ярко-красной, фонтанирующей крови, которая не останавливается, или при признаках шока.",
  },
  {
    id: "stroke",
    title: "Распознавание инсульта (FAST)",
    icon: Brain,
    color: "#7C3AED",
    severity: "critical",
    overview:
      "Инсульт требует срочного вмешательства. Используйте FAST: лицо, руки, речь, время звонить в 103.",
    callEmergency: true,
    steps: [
      {
        step: 1,
        title: "Лицо — проверьте асимметрию",
        description: "Попросите улыбнуться. Одна сторона лица может опуститься.",
      },
      {
        step: 2,
        title: "Руки — слабость",
        description: "Попросите поднять обе руки. Опускается ли одна из них?",
      },
      {
        step: 3,
        title: "Речь — нарушение",
        description: "Попросите повторить простую фразу. Косноязычие или спутанная речь — тревожный знак.",
      },
      {
        step: 4,
        title: "Время — звоните",
        description: "При любых признаках FAST сразу звоните 103 и отметьте время начала симптомов.",
      },
      {
        step: 5,
        title: "Удобное положение",
        description: "Пусть лежит с приподнятой головой, расстегните одежду.",
      },
      {
        step: 6,
        title: "Оставайтесь рядом",
        description: "Не давайте еду/воду, наблюдайте и будьте готовы к СЛР.",
      },
    ],
    doNots: [
      "Не давайте аспирин без указаний врача",
      "Не предлагайте еду и воду",
      "Не оставляйте без внимания симптомы",
      "Не откладывайте вызов скорой",
    ],
    whenToSeekHelp: "Вызывайте скорую при любом симптоме FAST — каждая минута важна.",
  },
  {
    id: "fractures",
    title: "Переломы и повреждения костей",
    icon: Bone,
    color: "#6366F1",
    severity: "urgent",
    overview:
      "Подозреваемый перелом нужно зафиксировать, чтобы не усугубить травму. Не пытайтесь вправлять кость.",
    callEmergency: false,
    steps: [
      {
        step: 1,
        title: "Оцените травму",
        description: "Осмотрите конечность на деформацию, отек и подчеркните боль при движении.",
      },
      {
        step: 2,
        title: "Иммобилизируйте",
        description: "Не двигайте конечность, зафиксируйте ее в текущем положении.",
      },
      {
        step: 3,
        title: "Холодный компресс",
        description: "Приложите лед, завернутый в ткань, чтобы уменьшить отек.",
      },
      {
        step: 4,
        title: "Сделайте шину",
        description:
          "Используйте жесткие предметы (доски, журналы), обернув мягкой тканью, чтобы зафиксировать суставы выше и ниже повреждения.",
      },
      {
        step: 5,
        title: "Закрепите шину",
        description: "Перевяжите полосами ткани, не пережимая, регулярно проверяйте пульс ниже шины.",
      },
      {
        step: 6,
        title: "Профилактика шока",
        description: "Держите пострадавшего в тепле, ноги немного приподнимите, если нет травмы таза/спины.",
      },
    ],
    doNots: [
      "Не пытайтесь выпрямить или вправить кость",
      "Не перемещайте человека при подозрении на травму позвоночника",
      "Не делайте шину слишком тугой",
    ],
    whenToSeekHelp:
      "При подозрении на перелом обратитесь к врачу. Вызывайте скорую, если кость видна, есть сильное кровотечение или травма шеи/спины.",
  },
  {
    id: "allergic-reaction",
    title: "Тяжелая аллергическая реакция (анафилаксия)",
    icon: Zap,
    color: "#EC4899",
    severity: "critical",
    overview:
      "Анафилаксия — опасная реакция, при которой дыхательные пути сужаются и давление падает. Срочно нужна помощь.",
    callEmergency: true,
    steps: [
      {
        step: 1,
        title: "Распознавайте симптомы",
        description: "Отек лица или горла, затрудненное дыхание, крапивница, учащенный пульс, головокружение, тошнота.",
      },
      {
        step: 2,
        title: "Вызовите скорую",
        description: "Наберите 103. Анафилаксия может быть смертельной за несколько минут.",
      },
      {
        step: 3,
        title: "Используйте адреналин",
        description: "Помогите использовать автоинжектор в бок бедра даже через одежду.",
      },
      {
        step: 4,
        title: "Удобное положение",
        description: "Если дышать тяжело, пусть сидит. Если кружится голова, пусть лежит с поднятыми ногами.",
      },
      {
        step: 5,
        title: "Смотрите за дыханием",
        description: "Готовьтесь к СЛР, если дыхание остановится.",
      },
      {
        step: 6,
        title: "Второй укол",
        description:
          "Если через 5-15 минут симптомы не проходят и есть второй автоинжектор, повторите введение.",
      },
    ],
    doNots: [
      "Не оставляйте человека одного",
      "Не давайте таблетки, если трудно дышать",
      "Не откладывайте адреналин, если он под рукой",
      "Не позволяйте вставать, если кружится голова",
    ],
    whenToSeekHelp:
      "Всегда вызывайте скорую при подозрении на анафилаксию. Даже после улучшения необходима медицинская оценка.",
  },
  {
    id: "poisoning",
    title: "Отравление и передозировка",
    icon: Pill,
    color: "#059669",
    severity: "critical",
    overview:
      "Отравление может быть вызвано лекарствами, химикатами или испорченной едой. Важно выяснить, что именно попало в организм.",
    callEmergency: true,
    steps: [
      {
        step: 1,
        title: "Определите вещество",
        description: "Найдите упаковки, таблетки или растения. Зафиксируйте дозу и время воздействия.",
      },
      {
        step: 2,
        title: "Позвоните токсикологам",
        description:
          "Свяжитесь со службой токсикологической помощи или скорой. Сообщите название вещества и приблизительную дозу.",
      },
      {
        step: 3,
        title: "Следуйте инструкциям",
        description: "Точно выполняйте указания специалистов. Не вызывайте рвоту без разрешения.",
      },
      {
        step: 4,
        title: "При вдыхании",
        description: "Проветрите помещение и перенесите человека на свежий воздух.",
      },
      {
        step: 5,
        title: "При контакте с кожей",
        description: "Снимите загрязненную одежду. Промойте кожу проточной водой 15-20 минут.",
      },
      {
        step: 6,
        title: "Наблюдайте за состоянием",
        description: "Следите за сознанием, дыханием и пульсом. При необходимости начинайте СЛР.",
      },
    ],
    doNots: [
      "Не вызывайте рвоту без разрешения токсиколога",
      "Не давайте ничего пить без указаний",
      "Не ждите симптомов — звоните сразу",
      "Не применяйте народные рецепты",
    ],
    whenToSeekHelp:
      "Позвоните токсикологической службе немедленно. Вызывайте скорую, если человек теряет сознание, судороги или затрудненное дыхание.",
  },
];

const firstAidGuidesByLanguage: Record<Language, FirstAidGuide[]> = {
  en: firstAidGuidesEnglish,
  ru: firstAidGuidesRu,
  kz: firstAidGuidesEnglish,
};
...
export default function FirstAidGuide() {
  ...
  const guides = firstAidGuidesByLanguage[language] ?? firstAidGuidesEnglish;
